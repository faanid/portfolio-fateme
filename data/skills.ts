...
export const skills: Skill[] = [
  // Frontend
  { id: "javascript", name: "JavaScript", category: "frontend", proficiency: 5, icon_name: "code", created_at: CREATED_AT },
  { id: "typescript", name: "TypeScript", category: "frontend", proficiency: 5, icon_name: "code", created_at: CREATED_AT },
  ...
  { id: "reactjs", name: "React.js", category: "frontend", proficiency: 5, icon_name: "code", created_at: CREATED_AT },
  { id: "nextjs", name: "Next.js", category: "frontend", proficiency: 5, icon_name: "code", created_at: CREATED_AT },

  // State management
  { id: "redux", name: "Redux", category: "state-management", proficiency: 4, icon_name: "layers", created_at: CREATED_AT },
  { id: "rtk", name: "RTK", category: "state-management", proficiency: 4, icon_name: "layers", created_at: CREATED_AT },
  { id: "zustand", name: "Zustand", category: "state-management", proficiency: 4, icon_name: "layers", created_at: CREATED_AT },
  { id: "tanstack-query", name: "TanStack Query", category: "state-management", proficiency: 4, icon_name: "layers", created_at: CREATED_AT },

  // Forms and validation
  { id: "react-hook-form", name: "React Hook Form", category: "frontend", proficiency: 4, icon_name: "code", created_at: CREATED_AT },
  { id: "zod", name: "Zod", category: "frontend", proficiency: 4, icon_name: "code", created_at: CREATED_AT },
  ...
  // Testing and tools
  { id: "jest", name: "Jest", category: "tools", proficiency: 3, icon_name: "wrench", created_at: CREATED_AT },
  { id: "axios", name: "Axios", category: "tools", proficiency: 4, icon_name: "wrench", created_at: CREATED_AT },
  ...
  { id: "gitlab", name: "GitLab", category: "tools", proficiency: 4, icon_name: "wrench", created_at: CREATED_AT },
  { id: "vite", name: "Vite", category: "tools", proficiency: 4, icon_name: "wrench", created_at: CREATED_AT },
  { id: "husky", name: "Husky", category: "tools", proficiency: 3, icon_name: "wrench", created_at: CREATED_AT },
  { id: "prettier", name: "Prettier", category: "tools", proficiency: 4, icon_name: "wrench", created_at: CREATED_AT },

  // Interested in learning
  { id: "svelte", name: "Svelte", category: "frontend", proficiency: 2, icon_name: "code", created_at: CREATED_AT },
  { id: "vuejs", name: "Vue.js", category: "frontend", proficiency: 2, icon_name: "code", created_at: CREATED_AT },
